...
// //           <p>Last Location: {typeof report.lastLocation === 'string' ? report.lastLocation.replace(/"/g, '') : report.lastLocation}</p>
// //           <p>Height: {typeof report.height === 'string' ? report.height.replace(/"/g, '') : report.height}</p>
// //           {report.submittedByFinder && report.finder && (
// //             <div>
// //               <h4>Submitted By Finder:</h4>
// //               <p>Name: {report.finder.name || 'Not provided'}</p>
// //               <p>Phone: {report.finder.phone || 'Not provided'}</p>
// //             </div>
// //           )}
// //           {!report.submittedByFinder && (
...
//           return;
//         }
//         const url = req.user.role === 'parent' ? `${process.env.REACT_APP_API_URL}/lost` : `${process.env.REACT_APP_API_URL}/found`;
...
//           )}
//           <h3>{typeof report.name === 'string' ? report.name.replace(/"/g, '') : report.name}</h3>
//           <p>Approximate Age: {report.approximateAge}</p>
//           <p>Location: {typeof report.location === 'string' ? report.location.replace(/"/g, '') : report.location}</p>
//           <p>Height: {typeof report.height === 'string' ? report.height.replace(/"/g, '') : report.height}</p>
//           <p>Appearance: {report.appearance || 'Not provided'}</p>
//           {req.user.role === 'parent' && !report.submittedByFinder && (
//             <p>Status: {report.isFound ? 'Found' : 'Not Found'}</p>
//           )}
